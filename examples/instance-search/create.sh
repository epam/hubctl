...
base_domain=smoke-$USER-aws01.dev.superhub.io
env=Demo01-smoke-$USER
...
for i in $(seq 1 50); do
    name=eks-$i
    hub api cluster create eks $name t3.medium 1 3 -e Demo01-smoke-arkadi -m K8s --kube-dashboard --eks-admin arkadi -s 0.05 -y
